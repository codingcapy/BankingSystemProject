...
class Account:
    ...
    def display_details(self):
        print(
            f"        Account Number: {self.account_num} | Account Type: {self.account_type} | Balance: ${self.balance}")
...
def save_data(input_list1, input_list2):
    ...
    with open("accounts_data.txt", "w") as accounts_data:
        for j in input_list2:
            accounts_data.write(f"{j.profile_num},{j.account_num},{j.account_type},{j.balance}\n")
